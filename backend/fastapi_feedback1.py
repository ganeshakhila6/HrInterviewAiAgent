...
async def send_email(candidate_email: str):
    ...
    c_body = f"""
<div style="font-family:-apple-system,Segoe UI,Roboto,Arial,sans-serif;max-width:600px;margin:0 auto;color:#1f2937;line-height:1.6;">
  <p>Dear {name},</p>

  <p>Thank you for applying for the <b>{role}</b> position with us.</p>

  <p>We are pleased to inform you that, after careful review of your profile and qualifications,
  you have been <b>shortlisted</b> for this role.</p>

  <p>Our recruitment team will reach out to you shortly with further details regarding the next
  steps in the hiring process.</p>

  <p>We appreciate your interest in joining our organization and look forward to speaking with you soon.</p>

  <br>
  <p>Warm regards,<br>
  <b>HR Recruitment Team</b></p>
</div>
"""
    hr_body = f"""
<div style="font-family:-apple-system,Segoe UI,Roboto,Arial,sans-serif;max-width:600px;margin:0 auto;color:#1f2937;">
  <h2 style="margin-bottom:4px;">New Shortlisted Candidate</h2>
  <p style="color:#6b7280;margin-top:0;">Auto-generated by AI Recruitment Agent</p>

  <table style="width:100%;border-collapse:collapse;font-size:14px;margin-top:12px;">
    <tr>
      <td style="padding:8px;border:1px solid #e5e7eb;background:#f9fafb;width:140px;"><b>Name</b></td>
      <td style="padding:8px;border:1px solid #e5e7eb;">{name}</td>
    </tr>
    <tr>
      <td style="padding:8px;border:1px solid #e5e7eb;background:#f9fafb;"><b>Email</b></td>
      <td style="padding:8px;border:1px solid #e5e7eb;">{candidate_email}</td>
    </tr>
    <tr>
      <td style="padding:8px;border:1px solid #e5e7eb;background:#f9fafb;"><b>Role</b></td>
      <td style="padding:8px;border:1px solid #e5e7eb;">{role}</td>
    </tr>
    <tr>
      <td style="padding:8px;border:1px solid #e5e7eb;background:#f9fafb;"><b>AI Score</b></td>
      <td style="padding:8px;border:1px solid #e5e7eb;">
        <span style="background:{'#16a34a' if score >= 85 else '#d97706' if score >= 75 else '#dc2626'};color:#fff;padding:2px 10px;border-radius:10px;font-weight:600;">
          {score}/100
        </span>
      </td>
    </tr>
    <tr>
      <td style="padding:8px;border:1px solid #e5e7eb;background:#f9fafb;"><b>Skills</b></td>
      <td style="padding:8px;border:1px solid #e5e7eb;">{skills}</td>
    </tr>
    <tr>
      <td style="padding:8px;border:1px solid #e5e7eb;background:#f9fafb;vertical-align:top;"><b>Summary</b></td>
      <td style="padding:8px;border:1px solid #e5e7eb;">{summary}</td>
    </tr>
  </table>

  <p style="font-size:12px;color:#9ca3af;margin-top:20px;">
    A candidate notification email has also been sent to {name} at {candidate_email}.
  </p>
</div>
"""
    c_sent  = send_ms_graph_email(f"You've Been Shortlisted — {role}", c_body, candidate_email)
    hr_sent = send_ms_graph_email(f"Shortlisted: {os.name} | {role}", hr_body, HR_APPROVER_EMAIL)
